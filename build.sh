...
export LD_LIBRARY_PATH=/group/xbjlab/dphi_software/software/workspace/xysheng/som/opt/petalinux/2020.2/sysroots/aarch64-xilinx-linux/install/Release/:$LD_LIBRARY_PATH
